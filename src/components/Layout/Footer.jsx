...
const GET_STARTED = [
    ...
    { label: "Schedule a Call", href: "https://cal.com/baazhq" },
    { label: "Newsletter", href: "https://saasinfra.substack.com" },
]
        ...
        <footer className={styles.footer}>
            <div className={styles.footerContent}>
                <div className={styles.footerGrid}>
                    ...
                    <FooterColumn heading="Get Started" items={GET_STARTED} />
                </div>

                <div className={styles.footerBottom}>
                    <p>
                        &copy; {new Date().getFullYear()} BaaZ. All rights
                        reserved.
                    </p>
                    <p className={styles.footerBottomLabel}>
